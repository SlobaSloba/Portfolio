...
This is a project that I have started recently.\
It is a work in progress which I do in my spare time, but I will try to showcase my skillset in data wrangling, analysis, visualisation, hypothesis testing, and modelling. The code is written in Python, SQL, and R.
